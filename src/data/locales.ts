...
export const LOCALES: LocaleInfo[] = [
  ...
  { code: "ar-SA", name: "Arabic (Saudi Arabia)",     tier: "tier-2", region: "MidEast" },
  { code: "ar-EG", name: "Arabic (Egypt)",            tier: "tier-2", region: "MidEast" },
  ...
  { code: "tr-TR", name: "Turkish (Türkiye)",         tier: "tier-2", region: "MidEast" },
  ...
  { code: "he-IL", name: "Hebrew (Israel)",           tier: "tier-3", region: "MidEast" },
